      ...
      <div className="step-library-layout">
        ...
        <main>
          ...
          {selectedAsset && selectedVersion && <section className="step-library-detail">
            ...
            <dl><div><dt>File</dt><dd>{selectedVersion.file_name} · {formatBytes(selectedVersion.size)}</dd></div><div><dt>Source unit</dt><dd>{selectedVersion.unit}</dd></div><div><dt>Fingerprint</dt><dd title={selectedVersion.sha256}>{selectedVersion.sha256.slice(0, 16)}…</dd></div>
