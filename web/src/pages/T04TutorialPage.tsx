  ...
  const lesson = () => {
    switch (step.id) {
      ...
      default: return <>
        ...
        <div className="run-readiness-card"><div className="run-ready-icon"><CheckCircle2 size={30}/></div><div><span>CONFIGURATION STATUS</span><strong>Two mutually exclusive strategies validated</strong><p>The explicit-edge Draft contains named edge controls; the Geometry AI Draft removes them and defines geometry accuracy and minimum passage size.</p></div></div>
