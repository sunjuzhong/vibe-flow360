...
export const t04Pedagogy: TutorialPedagogy = {
  ...
  derivations: [
    ...
    { id: 'height', parameter: 'Trailing-edge height normalized by chord', basis: 'The 0.7 mm baseline height is interpreted relative to the 1 m reference chord.', calculation: 'hTE/c = 0.0007/1 = 7×10⁻⁴', transfer: 'Recompute from new chord and actual trailing-edge thickness instead of copying 0.7 mm.' },
