...
The Web lesson lets the learner upload either supported mesh root. It creates the remote Project, then two configured Flow360 Case Drafts at α=0° and α=5°. No mesh or solver execution is submitted. Because boundary names belong to the uploaded mesh, both Drafts remain explicitly reviewable and must be mapped to physical boundary models before execution.
